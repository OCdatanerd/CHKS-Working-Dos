...
keep if  (district=="Orange County Department of Education"|district== "Anaheim Union High"| district=="Huntington Beach Union High")
...
generate sick= (a124_a114==2 | a125==2)
generate nosick= (a124_a114==1 & a125==1)
...
by aod_pres, sort : tab a124_a114
by aod_pres, sort : tab a125

by sick, sort : tab aod_pres
by nosick, sort : tab aod_pres
by aod_pres, sort : tab sick
