...
drop if (district=="Buena Park Elementary"|district=="Fountain Valley Elementary" ///
|district=="Fullerton Elementary"|district=="Huntington Beach City Elementary" ///
|district=="La Habra City Elementary"|district=="Ocean View"|district=="Westminster")
drop ctag1-ctag5
drop dasm1-dasm2
drop dasm5-gs1
drop gs4-sb19_sb14
...
gen stfemale = (a129_a118==1 & a3==2)
/* For Santa Ana*/ gen safemale = (a129_a118==1 & sana1==2)
replace stfemale = 1 if (stfemale==1|safemale==1)
gen lgbt= (a129_a118==2|a129_a118==3|a130_a119==2) if !missing(a129_a118|a130_a119)
replace lgbt = 2 if (a129_a118==6|a130_a119==4)
gen notsure= (a129_a118==4|a130_a119==3) if !missing(a129_a118|a130_a119)
gen femlgbt = (lgbt==1 & a3==2)
gen femlgb = ((a129_a118==2|a129_a118==3)&a3==2)
gen safemlgb = ((a129_a118==2|a129_a118==3)& sana1==2)
replace femlgb = 1 if (femlgb==1|safemlgb==1)
gen safemlgbt = (lgbt==1 & sana1==2)
gen tfemale = (a130_a119==2 & a3==2)
gen satfemale = (a130_a119==2 & sana1==2)
replace tfemale = 1 if (tfemale==1|satfemale==1)
gen allfemale = (a3==2|sana1==2)
...
by allfemale, sort : tab truancy
by stfemale, sort : tab truancy
by femlgb, sort : tab truancy
by tfemale, sort : tab truancy

by allfemale, sort : tab absence
by stfemale, sort : tab absence
by femlgb, sort : tab absence
by tfemale, sort : tab absence

by allfemale, sort : tab vv_pushed
by stfemale, sort : tab vv_pushed
by femlgb, sort : tab vv_pushed
by tfemale, sort : tab vv_pushed

by allfemale, sort : tab vv_weapon
by stfemale, sort : tab vv_weapon
by femlgb, sort : tab vv_weapon
by tfemale, sort : tab vv_weapon

by allfemale, sort : tab a60_a54
by stfemale, sort : tab a60_a54
by femlgb, sort : tab a60_a54
by tfemale, sort : tab a60_a54

by allfemale, sort : tab a124_a114
by stfemale, sort : tab a124_a114
by femlgb, sort : tab a124_a114
by tfemale, sort : tab a124_a114

by allfemale, sort : tab a125 
by stfemale, sort : tab a125 
by femlgb, sort : tab a125 
by tfemale, sort : tab a125 
