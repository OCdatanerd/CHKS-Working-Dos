...
keep if (district=="Dos Palos Oro Loma Joint Unified"|district=="Hilmar Unified"|district=="Le Grand Union High"|district=="Los Banos Unified"|district=="Merced Union High")
...
by grade, sort : tab connect_hi if a61==1
by grade, sort : tab connect_hi if a61==2
by grade, sort : tab connect_hi if a61==3
by grade, sort : tab connect_hi if a61==4
by grade, sort : tab connect_hi if a61==5
by grade, sort : tab connect_hi if a61==6
by grade, sort : tab connect_hi if a61==7
...
by grade, sort : tab vv_weapon if a61==1
by grade, sort : tab vv_weapon if a61==2
by grade, sort : tab vv_weapon if a61==3
by grade, sort : tab vv_weapon if a61==4
by grade, sort : tab vv_weapon if a61==5
by grade, sort : tab vv_weapon if a61==6
by grade, sort : tab vv_weapon if a61==7


by grade, sort : tab rh_race
by grade, sort : tab rh_race if a61==1
by grade, sort : tab rh_race if a61==2
by grade, sort : tab rh_race if a61==3
by grade, sort : tab rh_race if a61==4
by grade, sort : tab rh_race if a61==5
by grade, sort : tab rh_race if a61==6
by grade, sort : tab rh_race if a61==7
...
by grade, sort : tab aod_mari if a61==1
by grade, sort : tab aod_mari if a61==2
by grade, sort : tab aod_mari if a61==3
by grade, sort : tab aod_mari if a61==4
by grade, sort : tab aod_mari if a61==5
by grade, sort : tab aod_mari if a61==6
by grade, sort : tab aod_mari if a61==7


by grade, sort : tab aod_pres
by grade, sort : tab aod_pres if a61==1
by grade, sort : tab aod_pres if a61==2
by grade, sort : tab aod_pres if a61==3
by grade, sort : tab aod_pres if a61==4
by grade, sort : tab aod_pres if a61==5
by grade, sort : tab aod_pres if a61==6
by grade, sort : tab aod_pres if a61==7
...
by grade, sort : tab a125 if a61==1
by grade, sort : tab a125 if a61==2
by grade, sort : tab a125 if a61==3
by grade, sort : tab a125 if a61==4
by grade, sort : tab a125 if a61==5
by grade, sort : tab a125 if a61==6
by grade, sort : tab a125 if a61==7
