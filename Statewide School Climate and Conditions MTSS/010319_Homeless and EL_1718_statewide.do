...
by grade, sort : tab a5 if homeless==1
by grade, sort : tab a6 if homeless==1

tab homeless
by homeless, sort : tab lgbt

tab truancy
by homeless, sort : tab truancy
tab truancy if homeless==1

tab absence
by homeless, sort : tab absence 

tab scare_hi
by homeless, sort : tab scare_hi 

tab shigh_hi
by homeless, sort : tab shigh_hi

tab connect_hi
by homeless, sort : tab connect_hi
